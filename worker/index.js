...
JSON obrigatório: {"fronts":[{"label":"...","kind":"offer|differential"}]}`;
    ...
    if (url.pathname === "/api/generate" && request.method === "POST") {
      try {
        ...
        const strategyPrompt = `Você é o DIRETOR DE ESTRATÉGIA DIGITAL do Destrave. Você conduz a presença digital da pessoa e decide o que ela deve executar HOJE.\n\nCONTEXTO CONFIRMADO: ${JSON.stringify(cleanContext)}\nHISTÓRICO RECENTE: ${JSON.stringify(recent.slice(0,6))}\nFOCO SOBERANO: "${selectedFocus}"\n\nA PESSOA NÃO ESCOLHE O CANAL. VOCÊ ESCOLHE UM ÚNICO MOVIMENTO: REELS, STORIES, FEED ou WHATSAPP. Não faça rodízio automático. Escolha pelo objetivo, momento, histórico, disponibilidade para aparecer e tempo de hoje. Todo o movimento deve tratar EXCLUSIVAMENTE do foco soberano. Não misture curso, serviço, produto ou outra frente.\n\nAntes do formato, decida qual percepção, desejo ou ação precisa nascer hoje. DESEJO é princípio central: quando houver oferta, faça o público desejar a transformação, experiência ou benefício verdadeiro, sem inventar resultado, prova ou promessa. Criatividade estratégica é livre; fatos não são.\n\nREELS: use quando retenção, alcance, demonstração, posicionamento ou mensagem falada/visual forte fizer sentido. Os primeiros 3 segundos precisam prender. Proibido abrir com "Oi, eu sou...", "Hoje eu vim falar..." ou "Eu queria falar...".\nSTORIES: use quando relacionamento, aprofundamento, desejo, objeção, prova real ou conversa fizer sentido. A execução terá 5–7 Stories com começo, meio e fim.\nFEED: use quando a mensagem precisa ficar clara, consultável, compartilhável ou consolidar percepção.\nWHATSAPP: use quando proximidade e ação com audiência já próxima fizerem mais sentido. Não é obrigatório.\nSe o principal for Stories, pode recomendar reaproveitar 1–2 partes no Status do WhatsApp quando fizer sentido.\n\nJSON somente: {"channel":"REELS|STORIES|FEED|WHATSAPP","objective":"","audienceInsight":"","centralMessage":"","desiredPerception":"","desire":"","angle":"","whyThisChannel":"","tone":"","useFacts":[],"avoid":[]}`;
        ...
        const motherPrompt = `Você é o EXECUTOR CRIATIVO / SOCIAL MEDIA do Destrave. A estratégia e o canal já foram decididos. NÃO escolha outro canal e NÃO crie conteúdos extras.\n\nDECISÃO ESTRATÉGICA: ${JSON.stringify(strategy)}\nFATOS CONFIRMADOS: ${JSON.stringify(cleanContext)}\nFOCO SOBERANO: "${selectedFocus}"\nNada de outra frente do negócio pode entrar como assunto, oferta, CTA, exemplo ou benefício.\n\nUm movimento por dia, mas completo e forte. Desejo é central quando existe oferta: mostre por que aquilo importa e faça a pessoa querer a transformação, experiência ou benefício verdadeiro. Não force venda em todo conteúdo. Criatividade é livre; fatos não são. Não invente cliente, prova, depoimento, número, duração, sentimento, causa, consequência, resultado, experiência pessoal, método particular ou função do produto. Escreva como social media humano, atual e específico. Nada de marketinguês, clichê ou motivação vazia.\n\nSE channel=REELS: comece DIRETO pelo gancho. Os primeiros 3 segundos precisam criar retenção por curiosidade, tensão, desejo, contraste, demonstração ou percepção forte. PROIBIDO "Oi, eu sou...", "Hoje eu vim falar...", "Eu queria falar..." e apresentações. Entregue roteiro falável completo de 45–60s, cenas simples, texto na tela, legenda e CTA coerente.\nSE channel=STORIES: entregue 5–7 Stories conectados, nunca um só. Começo, desenvolvimento, desejo/percepção e fechamento/ação. Cada Story precisa dizer o que mostrar e o que falar/escrever.\nSE channel=FEED: decida post único ou carrossel. Se carrossel, entregue cada slide com copy real e progressão. Entregue legenda e CTA quando fizer sentido.\nSE channel=WHATSAPP: entregue execução apropriada para WhatsApp conforme a estratégia.\nCROSSPOST: somente se channel=STORIES e fizer sentido, sugira reaproveitar 1–2 partes no Status do WhatsApp. Não gere segundo pacote.\n\nJSON SOMENTE: {"needsInput":false,"question":"","channel":"","movementTitle":"","strategicGoal":"","why":"","steps":[{"title":"","instruction":""}],"readyToUse":[{"label":"","text":""}],"crossPost":{"enabled":false,"text":""}}`;
